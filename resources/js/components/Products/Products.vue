<template>
  <div>
    <div id="menu" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row">
          <div v-for="pharm in pharms" :key="pharm.id" class="col-md-4 col-sm-6">
            <!-- MENU THUMB -->
            <div
              @click="select(pharm)"
              class="menu-thumb wow fadeInUp"
              data-wow-delay="0.4s"
    ...
    <ordonnance v-model="products_selected"></ordonnance>
        ...
        <div class="search-panel__results">
          <ais-search-box>
            <div slot-scope="{ currentRefinement, isSearchStalled, refine }">
              <input
              placeholder="Saisissez le medicament..."
                type="search"
                v-model="product"
          ...
          <ais-hits>
            <template slot="item" slot-scope="{ item }">
              <h1>
                <ais-highlight :hit="item" attribute="designation" />
              </h1>
              <p>
...
//import 'instantsearch/themes/algolia-min.css';

export default {
  components: { productForm, ordonnance },
  props: ["pharms"],
  mounted() {},
  ...
  data() {
    return {
      ...
      pharm_selected: false,
      pharmacy: [],
      product: "",
      qte: 0,
      searchClient: algoliasearch(
        "OYWAZRSNB8",
        "240b36122bd66698e488cdfdb02614d8"
      )
    };
  },
  ...
  methods: {
    ...
    select(pharm) {
      this.pharmacy.push(pharm);
      this.pharm_selected = true;
    }
  }
};
</script>
